        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 pb-5">
                    <h1 class="heading mb-5 text-uppercase">Personal Websites</h1>
                </div>
                <div class="col-sm-6">
                    <img src="assets/images/personalwebsite.png" class="img-fluid" alt="">
                </div>
                <div class="col-sm-6">
                    <div class="text text-font pt-5">
                        <p>Thank you for visiting my personal website. I hope you find it informative, inspiring, and a
                            valuable resource for your own educational endeavors. Let's embrace the power of education
                            and make a difference in the world through the tools and opportunities provided by Grid Code
                            Media.</p>
                    </div>
                </div>
