        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 pb-5">
                    <h1 class="heading mb-5 text-uppercase">Web Development</h1>
                </div>
                <div class="col-sm-6">
                    <img src="assets/images/webdevelopment.png" class="img-fluid" alt="">
                </div>
                <div class="col-sm-6">
                    <div class="text text-font pt-5">
                        <p class="pt-5">Provide an overview of the company, its mission, and the services it offers in the web
                            ...
                            potential clients interested in their web development services.</p>
                    </div>
                </div>
