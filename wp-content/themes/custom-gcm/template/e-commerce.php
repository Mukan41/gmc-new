        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 pb-5">
                    <h1 class="heading mb-5 text-uppercase">E-Commerce Development</h1>
                </div>
                <div class="col-sm-6">
                    <img src="assets/images/ecommerce-website.png" class="img-fluid" alt="">
                </div>
                <div class="col-sm-6">
                    <div class="text text-font pt-5">
                        <p>Welcome to Grid Code Media’s online store, where creativity and innovation meet seamless shopping
                            experiences. Discover a wide range of digital media products and services that cater to your
                            creative needs. Our ecommerce platform is designed to provide a user-friendly interface, secure
                            transactions, and a personalized shopping journey. Explore our offerings and take your creative
