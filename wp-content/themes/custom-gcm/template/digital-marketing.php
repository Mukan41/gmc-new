        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 pb-5">
                    <h1 class="heading mb-5 text-uppercase">Digital Marketing</h1>
                </div>
                <div class="col-sm-6">
                    <img src="assets/images/digitalmarketing.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-sm-6">
                    <div class="text text-font pt-5">
                        <p>Digital marketing is a powerful strategy that utilizes various online channels and platforms
                            to reach and engage with a targeted audience, promote products or services, and drive
                            business growth. At Grid Code Media, we offer comprehensive digital marketing solutions
                            tailored to meet your unique marketing goals and maximize your online presence. Discover how
                            our expertise in digital marketing can help you achieve measurable results and connect with
