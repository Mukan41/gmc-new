<?php /* Template Name: Content Writing */ ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 pb-5">
                    <h1 class="heading mb-5">Content Writing</h1>
                </div>
                <div class="col-sm-6">
                    <img src="assets/images/content-writing.png"
                    class="img-fluid"    alt="">
                </div>
                <div class="col-sm-6">
                    <div class="text text-font ">
                        <p>Content writing is the art of crafting engaging, informative, and persuasive written material for
                            various mediums such as websites, blogs, social media, and marketing collateral. At Grid Code
                            Media, our content writing services are designed to captivate your audience, convey your brand’s
                            message effectively, and drive meaningful engagement. Discover how our expert content writers
                            can help you create compelling content that resonates with your target audience.</p>
                    </div>
                </div>
