        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 mb-5">
                    <h2 class="text-center text-white sections-main-heading">How Can We Help?</h2>
                </div>

                <div class="col-sm-4 d-flex ">
                    <div class="service">
                        <h3 class="service-heading content-heading">Creative Design</h3>
                        <p class="service-description text-font">Our team of professional graphic and web designers will help you with unique and
                            creative
                            logo and website designs that will match your business.</p>
                    </div>
                </div>

                <div class="col-sm-4 d-flex">
                    <div class=" service item-content">
                        <h3 class="service-heading content-heading">Research & Development</h3>
                        <p class="service-description text-font">We help you develop the right website with a good user interface built after a lot of
                            research in the industry to help you make the best out of it.</p>
                    </div>
                </div>

                <div class="col-sm-4 d-flex">
                    <div class="service">
                        <h3 class="service-heading content-heading">Branding & Marketing</h3>
                        <p class="service-description text-font">Need help with branding and marketing to reach out to a larger audience? We can help you
                            create a brand presence and marketing efforts.</p>
                    </div>
                </div>

                <div class="d-flex justify-content-center mt-5">
                    <button type="button" class=" Get-in-touch-btn">Get in touch</button>
                </div>
                ...
                <div class="col-sm-12 d-flex align-items-center swiper-wrapper">
                    <div class="swiper-slide">
                        <a href="https://pigglestg.wpengine.com/">
                            <img src="assets/images/piggle.png" class="img-fluid piggle-img" alt="piggle"
                                title="Piggle">
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="https://kusumtourandtravels.com/">
                            <img src="assets/images/Kusum-Tour-Travels-3.png" class="img-fluid kusum-img"
                                alt=" Kusum tour and travels" title="Kusum Tour and Travels">
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="https://jolgeractive.com/">
                            <img src="assets/images/Jolger_logo.jpg" class="img-fluid jolger-img" alt=" jolger"
                                title="Jolger">
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="https://tejcabs.com/">
                            <img src="assets/images/tej-cabs-final (1).png" class="img-fluid tejcab-img" alt="tej cabs"
                                title="Tej Cabs">
                        </a>
                    </div>
                    <div class="swiper-slide ">
                        <a href="https://pinaka-1235.myshopify.com/">
                            <img src="assets/images/pinaka-logo.webp" class="img-fluid pinaka-img" alt="pinaka"
                                title="pinaka">
                        </a>
                    </div>
                    <div class="swiper-slide">
                    ...
                    <div class="swiper-slide">
                        <a href="https://kusumtourandtravels.com/">
                            <img src="assets/images/Kusum-Tour-Travels-3.png" class="img-fluid tejcab-img"
                                alt=" Kusum tour and travels" title="Kusum Tour and Travels">
                        </a>
                    </div>
                    <div class="swiper-slide">
