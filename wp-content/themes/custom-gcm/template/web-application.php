...
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 pb-5">
                    <h1 class="heading mb-5 text-uppercase">Web Application</h1>
                </div>
                <div class="col-sm-6">
                    <img src="assets/images/webapplication.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-sm-6">
                    <div class="text text-font pt-5">
                        <p>
                            Welcome to the Grid Code Media Web Application! We're thrilled to introduce you to our
                            innovative platform that will revolutionize the way you engage with educational content. Our
                            web application combines cutting-edge technology with a user-friendly interface, making
                            learning and collaboration effortless.With the Grid Code Media Web Application, you'll have
                            access to a vast library of educational resources, interactive courses, and engaging
                            multimedia content. Whether you're a student, teacher, or lifelong learner, our application
                            is designed to meet your unique needs and enhance your educational journey.</p>
                    </div>
                </div>
    ...
    <!-- Deliver Projects -->
    <!-- <section class="delever-project-section  ">
        <div class="container mb-5">
            <h1 class="text-center sections-main-heading text-uppercase">Deliver Projects</h1>
        </div>
