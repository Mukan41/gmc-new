<?php /* Template Name: Educational Website */ ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 pb-5">
                    <h1 class="heading mb-5 text-uppercase">Education Websites</h1>
                </div>
                <div class="col-sm-6">
                    <img src="assets/images/online-education.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-sm-6">
                    <div class="text text-font pt-4">
                        <p>Welcome to Grid Code Media, your trusted online destination for educational resources and
                            content. At Grid Code Media, we believe in the transformative power of education and its
                            ability to empower individuals to reach their full potential. With a vast collection of
                            educational materials, we strive to make learning engaging, accessible, and enjoyable for
                            learners of all ages. Whether you're a student, teacher, or lifelong learner, we have
                            something for you.</p>
                    </div>
                </div>
